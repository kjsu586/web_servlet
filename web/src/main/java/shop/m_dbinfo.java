package shop;
//Database, 사용자 아이디, 사용자 패스워드 등록 / 테이블은 별도
...
public class m_dbinfo {
	...
	public static Connection getConnection() throws Exception{
		...
		String db_driber = "com.mysql.cj.jdbc.Driver";
		//Database 경로 연결 : jdbc:mysql://IP 또는 도메인:port번호/Database명
		String dr_url = "jdbc:mysql://localhost:3306/mrp";
		//mysql에 접속하는 사용자
		...
		Connection con = DriverManager.getConnection(dr_url,db_user,db_passwd);
		//System.out.println(con);
		return con; //데이터베이스가 정상적으로 연결이 되었는지 확인 결과를 return함
	}
