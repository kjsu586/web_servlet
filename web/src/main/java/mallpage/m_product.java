...
public class m_product {
	...
	dto_product pd = new dto_product(); //void 메소드일 경우 컨트롤러에서 가져가는 객체
	...
	ResultSet rs = null; //select문 사용하기 위해
	String sql = null;
	...
	//상품 하나의 정보만 가져오는 모델
	public void oneproduct(dto_product p) { //컨트롤에서 보내준 DTO 값을 받음
		...
		try {
			...
			else { //필드에 있는 DTO 모델에 setter로 DB값을 전달
